<template>
  <section style="display: inline">
    <let-button theme="primary" :disabled="disabled" @click="init">{{$t('dcache.nonServerMigration')}}</let-button>
    <let-modal
      v-model="show"
      :footShow="false"
    ...
    >
      <let-form ref="detailForm" labelPosition="right" class="non-server-migration" v-if="show" >
        ...
        <let-form-item required :label="$t('dcache.operationManage.moduleName') + '：'">
          {{moduleName}}
        </let-form-item>
